...
public class AddProductTest {
	...
	void testProductAdd_success() {
		...
		addProduct.click();
		WebElement name = driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[1]/div/div/input");
		name.sendKeys("Chilly Chicken");
		WebElement price = driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[2]/div/div/input");
		price.sendKeys("200");
		WebElement description = driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[3]/div/div/input");
		description.sendKeys("200");
		ISelect category = new Select(driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[4]/div/div/select"));
		category.selectByVisibleText("Chinese");
		ISelect foodimage = new Select(driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[5]/div/div/select"));
		foodimage.selectByVisibleText("Chilly Chicken");
		ISelect categoryimage = new Select(driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[6]/div/div/select"));
		categoryimage.selectByVisibleText("Chinese");
		WebElement seller = driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[1]/div[7]/div/div/input");
		seller.sendKeys("Golden Spoon");
		driver.findElementByXPath("/html/body/app-root/app-products/app-createproduct/div/div/div/form/div[2]/button[1]").click();
