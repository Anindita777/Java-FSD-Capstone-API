...
public class AddOrderTest {
	...
	void testOrderAdd_success() {
		...
		WebElement email = driver.findElementByXPath("/html/body/app-root/app-orderdetails/div[2]/form/div[1]/div/div/input");
		email.sendKeys("Alisha.Panda@dell.com");
		WebElement address = driver.findElementByXPath("/html/body/app-root/app-orderdetails/div[2]/form/div[2]/div/div/input");
		address.sendKeys("ABC Apartments");
		WebElement phone = driver.findElementByXPath("/html/body/app-root/app-orderdetails/div[2]/form/div[3]/div/div/input");
		phone.sendKeys("845672345");
		
		WebElement addOrder1 = driver.findElementByXPath("/html/body/app-root/app-orderdetails/div[2]/form/button");
		addOrder1.click();
